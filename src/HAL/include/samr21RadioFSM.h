...
typedef enum RadioJobState{
    ...
    //TX States
    MARKER_RADIO_STATES_BEGINN_TX             = 0x20,
    RADIO_STATE_TX_READY                      = 0x21,
    RADIO_STATE_TX_CCA                        = 0x22,
    RADIO_STATE_TX_CCA_EVAL                   = 0x23,  
    RADIO_STATE_TX_CCA_BACKOFF                = 0x24,
    RADIO_STATE_TX_SENDING                    = 0x25, 
    RADIO_STATE_TX_SENDING_ACK_REQUESTED      = 0x26,
    RADIO_STATE_TX_WAITING_FOR_ACK            = 0x27,
    RADIO_STATE_TX_RECEIVING_ACK              = 0x28,
    RADIO_STATE_TX_EVAL_ACK                   = 0x29,
    RADIO_STATE_TX_EVAL_RETRANSMISSIOM        = 0x2A,
    MARKER_RADIO_STATES_END_TX                = 0x2F,
    ...
    MARKER_RADIO_STATES_BEGINN_OTHER_DONE     = 0xF0,
    RADIO_STATE_RX_DONE                       = 0xF1,
    RADIO_STATE_TX_DONE                       = 0xF2,
    RADIO_STATE_ED_DONE                       = 0xF3,
    RADIO_STATE_TX_FAILED                     = 0xFA,
    RADIO_STATE_ED_FAILED                     = 0xFB,
    MARKER_RADIO_STATES_END_OTHER_DONE        = 0xFF,
} RadioJobState;
